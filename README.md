...
- [icalendar](http://robur.io/Projects/CalDAV) - bespoke minimal OCaml CalDAV server running on mirageOS unikernal. ([Source Code](https://github.com/roburio/icalendar)). No license.
